...
#define TIMER_ROWS                        2|NAVIGATION_LINE_BY_LINE, 0, CASE_PERSISTENT_TIMERS(0) 0, 0
  ...
  #define EXTERNAL_MODULE_MODE_ROWS       ((g_model.externalModule==MODULE_TYPE_XJT && g_model.moduleData[EXTERNAL_MODULE].rfProtocol==RF_PROTO_X16) || IS_MODULE_DSM2(EXTERNAL_MODULE)) ? (uint8_t)1 : (uint8_t)0
#else
